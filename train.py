...
tf.flags.DEFINE_integer("evaluate_every", 134, "Evaluate model on dev set after this many steps (default: 100)")
tf.flags.DEFINE_integer("checkpoint_every", 134, "Save model after this many steps (default: 100)")
